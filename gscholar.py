...
def convert_pdf_to_txt(pdf, startpage=None):
    ...
    stdout = subprocess.Popen(['xdg-open', pdf],
...
if __name__ == "__main__":
    title = 'A Joint Decoding Algorithm for Named Entity Recognition'
    path = '/Users/caoyixin/Github/cloudPapers/test2/2.pdf'
    print(pdflookup(path, False, FORMAT_BIBTEX))